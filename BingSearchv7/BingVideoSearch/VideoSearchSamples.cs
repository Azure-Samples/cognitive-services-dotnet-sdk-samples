namespace bing_search_dotnet.Samples
{
    ...
    {
        [Example("This will search videos for (SwiftKey) then verify number of results and print out id, name and url of first video result")]
        ...
        [Example("This will search videos for (Bellevue Trailer) that is free, short and 1080p resolution then verify number of results and print out id, name and url of first video result")]
        ...
        [Example("This will search videos for (Bellevue Trailer) and then search for detail information of the first video")]
